...
program define synth_did
    ...
    preserve
        ...
        twoway ///
            ...
            scheme(s2color)
        graph export "outputs/panel/solar_diff_and_diff/on_fossil_share/synth_path_solar_share_`tag'.png", ///
        ...
        twoway ///
            ...
            note("Synthetic control (Abadie et al. 2010).", size(vsmall)) ///
            scheme(s2color)
        graph export "outputs/panel/solar_diff_and_diff/on_fossil_share/synth_path_fossil_share_`tag'.png", ///
            replace width(1400) height(900)
    restore
    ...
    preserve
        ...
        graph export "outputs/panel/solar_diff_and_diff/on_fossil_share/event_study_solar_share_`tag'.png", ///
            replace width(1400) height(900)
    restore

    di as text "Done [`tag']. Outputs in outputs/panel/solar_diff_and_diff/on_fossil_share/"
end
...
di as text ""
di as text "All done. Outputs saved to outputs/panel/solar_diff_and_diff/on_fossil_share/"
