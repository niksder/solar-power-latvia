...
program define synth_did
    ...
    preserve
        ...
        twoway ///
            ...
            scheme(s2color)
        graph export "outputs/panel/solar_diff_and_diff/synthetic/synth_path_solar_prod_`tag'.png", ///
    ...
    preserve
        ...
        graph export "outputs/panel/solar_diff_and_diff/synthetic/cumulative_solar_prod_`tag'.png", ///
            replace width(1400) height(900)
    restore
