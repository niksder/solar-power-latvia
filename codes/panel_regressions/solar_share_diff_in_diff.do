...
drop _tmp2
label var solar_share_pre "Solar share on Feb 23 2022 (pre-war baseline, %)"
...
// Spec 1: solar share
xtreg solar_share c.gas_share_pre_pct#i.post solar_share_pre ///
...
xtreg ln_solar_share c.gas_share_pre_pct#i.post solar_share_pre ///
    temperature hdd cdd wind ln_sun precipitation precipitation_weekly precipitation_monthly ///
    i.day_of_week i.month, ///
    fe vce(cluster bzone_id)
eststo did_log
...
//
//   Reference period: H2 2021 (hy_seq_pos = 10)
...
//     hy_seq: -3=H1 2020, -2=H2 2020, -1=H1 2021, 0=H2 2021 (ref),
//              1=H1 2022, 2=H2 2022, 3=H1 2023, ..., 8=H2 2025
//   hy_seq_pos = hy_seq + 10  (Stata factor variables must be non-negative)
//     hy_seq_pos: 7=H1 2020, 8=H2 2020, 9=H1 2021, 10=H2 2021 (ref), ...
// =============================================================================
...
label var hy_seq_pos "Half-year (10 = H2 2021, reference period)"
...
local inter_vars ""
foreach k of local hy_pos_vals {
    if `k' != 10 local inter_vars "`inter_vars' inter_hy`k'"
}

// Two-way FE: bzone absorbed by xtreg fe, period absorbed by ib10.hy_seq_pos.
...
preserve
    ...
    twoway ///
        ...
        xline(0.5, lpattern(dash) lcolor(red) lwidth(medthick)) ///
        xlabel( ///
            -3 "H1 2020" -2 "H2 2020" -1 "H1 2021" 0 "H2 2021" ///
             1 "H1 2022"  2 "H2 2022"  3 "H1 2023"  4 "H2 2023" ///
             5 "H1 2024"  6 "H2 2024"  7 "H1 2025"  8 "H2 2025", ///
        ...
        subtitle("DiD event study; reference = H2 2021; red line = invasion Feb 24 2022") ///
    ...
    // of zero gas dependence) relative to the H2 2021 reference period.
    // -------------------------------------------------------------------------
    ...
    twoway ///
        ...
        subtitle("DiD coefs × Latvia gas share (`lv_gas_fmt' pp); ref = H2 2021; red = invasion") ///
