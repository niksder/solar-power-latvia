...
// Spec 1: solar share
xtreg solar_share_growth c.gas_share_pre_pct#i.post solar_share_pre_pct ///
...
gen ln_solar_share = ln(solar_share_growth + 1)
label var ln_solar_share "ln(solar_share_growth + 1)"

// Spec 2: ln(solar_share_growth + 1) — semi-elasticity interpretation
...
xtreg solar_share_growth `inter_vars' solar_share_pre_pct ///
...
preserve
    ...
    // Interpretation: extra pp of solar share growth Latvia gained (vs. counterfactual
